  ...
  $.getJSON("/data/classement_M2000_norvt.json",
    function (data) {
      ...
      if (data[0]) {
        ...
        player_M2000_norvt += '<td><img src="/images/medal_gold.png" alt=""></td>';
  ...
  $.getJSON("/data/classement_F18_norvt.json",
    function (data) {
      ...
      if (data[0]) {
        ...
        player_F18_norvt += '<td><img src="/images/medal_gold.png" alt=""></td>';
  ...
  $.getJSON("/data/classement_F14_norvt.json",
    function (data) {
      ...
      if (data[0]) {
        ...
        player_F14_norvt += '<td><img src="/images/medal_gold.png" alt=""></td>';
  ...
  $.getJSON("/data/classement_F16_norvt.json",
    function (data) {
      ...
      if (data[0]) {
        ...
        player_F16_norvt += '<td><img src="/images/medal_gold.png" alt=""></td>';
  ...
  $.getJSON("/data/classement_JF17_norvt.json",
    function (data) {
      ...
      if (data[0]) {
        ...
        player_JF17_norvt += '<td><img src="/images/medal_gold.png" alt=""></td>';
